...
fn integration_test_map_myhashmap_put_case2() {
    ...
    println!(
        "integration_test_map_myhashmap_put_case2 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "integration_test_map_myhashmap_put_case2 (nanos): {}",
...
fn integration_test_map_myhashmap_get_case3() {
    ...
    println!(
        "integration_test_map_myhashmap_get_case3 (milliseconds): {}",
        elapsed_time.as_millis()
    );

    println!(
        "integration_test_map_myhashmap_get_case3 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
fn integration_test_map_myhashmap_remove_case3() {
    ...
    println!(
        "integration_test_map_myhashmap_remove_case3 (milliseconds): {}",
        elapsed_time.as_millis()
    );

    println!(
        "integration_test_map_myhashmap_remove_case3 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
