...
pub fn integration_test_set_mybtreeset_add_case1() {
    ...
    println!("mybtreeset add case1 (milliseconds): {}", elapsed_time.as_millis());
    println!("mybtreeset add case1 (nanoseconds): {}", elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_add_case2() {
    ...
    let max_usize:usize = MAX as usize;
    assert_eq!(my_hash_set.size(),max_usize-1);
    println!("mybtreeset add case2 (milliseconds): {}", elapsed_time.as_millis());
    println!("mybtreeset add case2 (nanoseconds): {}", elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_remove_case1() {
    ...
    println!("mybtreeset remove case1 (milliseconds): {}", elapsed_time.as_millis());
    println!("mybtreeset remove case1 (nanoseconds): {}", elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_remove_case2() {
    ...
    let expected_size = MAX as usize - 2;
    assert_eq!(my_hash_set.size(),expected_size);
    println!("mybtreeset remove case2 (milliseconds): {}", elapsed_time.as_millis());
    println!("mybtreeset remove case2 (nanoseconds): {}", elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_contains_case1() {
    ...
    let elapsed_time = now.elapsed();
    assert!(contains);
    println!("mybtreeset contains case1 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset contains case1 (nanoseconds): {}", 
...
pub fn integration_test_set_mybtreeset_contains_case2() {
    ...
    assert!(!contains);
    println!("mybtreeset contains case2 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset contains case2 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_size_case1() {
    ...
    let elapsed_time = now.elapsed();
    assert_eq!(size,0);
    println!("mybtreeset size case1 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset size case1 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_size_case2() {
    ...
    println!("mybtreeset size case2 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset size case2 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_size_case3() {
    ...
    assert_eq!(size,expected_size);
    println!("mybtreeset size case3 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset size case3 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_is_empty_case1() {
    ...
    assert!(is_empty);
    println!("mybtreeset is_empty case1 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset is_empty case1 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_is_empty_case2() {
    ...
    let elapsed_time = now.elapsed();
    assert!(!is_empty);
    println!("mybtreeset is_empty case2 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset is_empty case2 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}
...
pub fn integration_test_set_mybtreeset_is_empty_case3() {
    ...
    let elapsed_time = now.elapsed();
    assert!(is_empty);
    println!("mybtreeset is_empty case3 (milliseconds): {}", 
        elapsed_time.as_millis());
    println!("mybtreeset is_empty case3 (nanoseconds): {}", 
        elapsed_time.as_nanos());
}