...
pub fn integration_test_set_myhashset_add_case1() {
    ...
    println!(
        "myhashset add case1 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset add case1 (nanoseconds): {}",
...
pub fn integration_test_set_myhashset_add_case2() {
    ...
    assert_eq!(my_hash_set.size(), max_usize - 1);
    println!(
        "myhashset add case2 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset add case2 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_remove_case1() {
    ...
    println!(
        "myhashset remove case1 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset remove case1 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_remove_case2() {
    ...
    assert_eq!(my_hash_set.size(), expected_size);
    println!(
        "myhashset remove case2 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset remove case2 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_contains_case1() {
    ...
    assert!(contains);
    println!(
        "myhashset contains case1 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset contains case1 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_contains_case2() {
    ...
    assert!(!contains);
    println!(
        "myhashset contains case2 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset contains case2 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_size_case1() {
    ...
    assert_eq!(size, 0);
    println!(
        "myhashset size case1 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset size case1 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_size_case2() {
    ...
    println!(
        "myhashset size case2 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset size case2 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_size_case3() {
    ...
    assert_eq!(size, expected_size);
    println!(
        "myhashset size case3 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset size case3 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_is_empty_case1() {
    ...
    assert!(is_empty);
    println!(
        "myhashset is_empty case1 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset is_empty case1 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_is_empty_case2() {
    ...
    assert!(!is_empty);
    println!(
        "myhashset is_empty case2 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset is_empty case2 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
...
pub fn integration_test_set_myhashset_is_empty_case3() {
    ...
    assert!(is_empty);
    println!(
        "myhashset is_empty case3 (milliseconds): {}",
        elapsed_time.as_millis()
    );
    println!(
        "myhashset is_empty case3 (nanoseconds): {}",
        elapsed_time.as_nanos()
    );
}
