...
#[test]
pub fn integration_test_list_myveclist_cons_case1() {
...
#[test]
pub fn integration_test_list_myveclist_head_case1() {
    let mut my_list: MyVecList<String> = MyVecList::nil();
...
#[test]
pub fn integration_test_list_myveclist_head_case2() {
    let mut my_list: MyVecList<String> = MyVecList::nil();
    let element = String::from("Hello");
    my_list.cons(element);
    let head = my_list.head();
...
#[test]
pub fn integration_test_list_myveclist_tail_case1() {
    let mut my_list: MyVecList<String> = MyVecList::nil();
    my_list.tail();
    let head = my_list.head();
    let expected_head = None;
...
#[test]
pub fn integration_test_list_myveclist_tail_case2() {
    let mut my_list: MyVecList<String> = MyVecList::nil();
    let element = String::from("Hello");
    my_list.cons(element);
    my_list.tail();
...
#[test]
pub fn integration_test_list_myveclist_is_empty_case1() {
    let mut my_list: MyVecList<String> = MyVecList::nil();
    assert!(my_list.is_empty());
}

#[test]
pub fn integration_test_list_myveclist_is_empty_case2() {
    let mut my_list: MyVecList<String> = MyVecList::nil();
    let element = String::from("Hello");
    my_list.cons(element);
    assert!(!my_list.is_empty());
