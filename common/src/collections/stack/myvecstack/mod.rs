...
mod tests {
    ...
    fn test_myvecstack_case1() {
        let mystack: MyVecStack<String> = MyVecStack { values: Vec::new() };
        let mystack2: MyVecStack<String> = MyVecStack { values: Vec::new() };
        assert_eq!(mystack, mystack2)
    }

    #[test]
    fn test_myvecstack_new_case1() {
        let mystack: MyVecStack<String> = MyVecStack::new();
        let mystack2: MyVecStack<String> = MyVecStack { values: Vec::new() };
        assert_eq!(mystack, mystack2)
    }
    ...
    fn test_myvecstack_new2_case1() {
        let mystack = MyVecStack::new2(String::from("Hello"));
        let mystack2: MyVecStack<String> = MyVecStack {
            values: Vec::from([String::from("Hello")]),
        };
        assert_eq!(mystack, mystack2)
    }
    ...
    fn test_myvecstack_from_case1() {
        let mystack = MyVecStack::from(Vec::from([String::from("Hello")]));
        let mystack2: MyVecStack<String> = MyVecStack {
            values: Vec::from([String::from("Hello")]),
        };
        assert_eq!(mystack, mystack2)
    ...
    fn test_myvecstack_push_case1() {
        let mut mystack: MyVecStack<String> = MyVecStack::new();
    ...
    fn test_myvecstack_push_case2() {
        ...
        let mystack2: MyVecStack<String> = MyVecStack {
            values: Vec::from([String::from("Hello"), String::from("World")]),
        };
        assert_eq!(mystack, mystack2)
    }
