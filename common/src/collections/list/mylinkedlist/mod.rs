...
mod tests {
    ...
    fn test_mylinkedlist_case1() {
        let mylist: MyLinkedList<String> = MyLinkedList {
            values: LinkedList::new(),
        };
        let mylist2: MyLinkedList<String> = MyLinkedList {
            values: LinkedList::new(),
        };
    ...
    fn test_mylinkedlist_case2() {
        let mylist: MyLinkedList<String> = MyLinkedList {
            values: LinkedList::from([String::from("Hello")]),
        };
        let mylist2: MyLinkedList<String> = MyLinkedList {
            values: LinkedList::from([String::from("Hello")]),
        };
    ...
    fn test_mylinkedlist_new_case1() {
        let mylist: MyLinkedList<String> = MyLinkedList::new();
        let mylist2: MyLinkedList<String> = MyLinkedList {
            values: LinkedList::new(),
        };
        assert_eq!(mylist, mylist2)
    ...
    fn test_mylinkedlist_nil_case1() {
        ...
        let mylist2: MyLinkedList<String> = MyLinkedList::new();
        assert_eq!(mylist, mylist2)
    }
    ...
    fn test_mylinkedlist_cons_case2() {
        ...
        let mylist2: MyLinkedList<String> = MyLinkedList {
            values: LinkedList::from([String::from("World"), String::from("Hello")]),
        };
        assert_eq!(mylist, mylist2)
    }
