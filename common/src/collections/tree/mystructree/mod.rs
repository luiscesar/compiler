...
impl<T:PartialEq> MyStructTree<T> {
    ...
    pub fn add(&mut self, child_root:T) {
        let child = 
            MyStructTree{root:child_root,children:Vec::new()};
        self.children.push(child);
    }

    pub fn remove_child(&mut self, child:&MyStructTree<T>) {
        let index = 
            self.children.iter().position(|x| 
                {
                    *x==*child
                });
        match index {
...
mod tests {
    ...
    fn get_root_case1() -> IpAddr {
        let ip_address_info = 
            IpAddrInfo {
            ip:1,network:String::from("1.1.1.1")
        };
    ...
    fn test_mystructtree_case1() {
        let mytree:MyStructTree<String> = 
            MyStructTree { root:String::from("root"), children:Vec::new()};
        let mytree2:MyStructTree<String> = 
            MyStructTree { root:String::from("root"), children:Vec::new()};
    ...
    fn test_mystructtree_case2() {
        ...
        let mytree = 
            MyStructTree {root:root1, children:Vec::new()};

        let root2 = get_root_case1();
        let mytree2 = 
                MyStructTree {root:root2, children:Vec::new()};    
    ...
    fn test_mystructtree_children_case2() {
        ...
        let root2 = get_root_case2();
        let mut mytree2 = 
            MyStructTree {root:root2, children:children};
    ...
    fn test_mystructtree_remove_child_case2() {
        ...
        let root2 = get_root_case2();
        let mut mytree2 = 
            MyStructTree {root:root2, children:Vec::from([mytree])};
