...
pub const RELATIONAL_OPERATOR_EXPECTED:&str = "A relational operator (==, !=, <, <=, >, >=) is expected";
...
pub const VALUES_ASSIGNMENT_EQUAL_TYPES:&str = "Values in assignmet are expected to have equal types";
