...
use crate::parser::expr::{types::INT, Expr, constant::{Constant}, arith::op::ArithBinaryOperator, ExprT, id::Id};
...
fn test_parser_expr_relational_new_case2() {
    ...
    let expr1_result = 
        Expr::new_arith_binary_operation_expr_ptr(
    ...
    let relational_expr_result = 
        Expr::new_relational_expr_ptr(operator, &id_expr_ptr, &expr_ptr);
